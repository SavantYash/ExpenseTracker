...
export default function RegisterScreen({ navigation }) {
    ...
    useEffect(() => {
        ...
        Animated.stagger(150, [
            ...
            Animated.timing(confirmAnim, { toValue: 1, duration: 500, useNativeDriver: true }),
            ...
            >
                {({ handleChange, handleBlur, handleSubmit, values, errors, touched }) => (
                    <>
                        ...
                        <Animated.View style={{ opacity: confirmAnim, transform: [{ translateY: confirmAnim.interpolate({ inputRange: [0, 1], outputRange: [20, 0] }) }] }}>
                            <TextInput
...
const styles = StyleSheet.create({
    container: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#f0f4f7', paddingHorizontal: 30 },
    title: { fontSize: 28, fontWeight: '700', marginBottom: 40, color: '#333' },
    input: { color: '#000', backgroundColor: '#fff', paddingHorizontal: 20, paddingVertical: 14, borderRadius: 10, fontSize: 16, marginBottom: 10, width: 300, elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4 },
    button: { backgroundColor: '#4a90e2', paddingVertical: 14, borderRadius: 10, alignItems: 'center', width: 300 },
